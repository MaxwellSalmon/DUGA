...
class Music:
    ...
    def __init__(self):
        ...
        pygame.mixer.Sound.set_volume(self.base_track, max(0, self.settings_volume - self.menu_volume))
        pygame.mixer.Sound.set_volume(self.hard_track, max(0, self.hard_volume - self.menu_volume))
